...
class RecordEditViewModel @Inject constructor(
    ...
    private val recordId: Int? = savedStateHandle[RecordEditDestination.recordIdArg]

    init {
        viewModelScope.launch {
            recordUiState = if (recordId != null) {
...
fun RecordWithPayments.toRecordUiState(actionEnabled: Boolean = false): RecordUiState =
    RecordUiState(
        id = record.id,
